...
export const AddAccessoryCategoryButton = () => {

    const openModal = () => {
        const dialog = document.getElementById('add-new-accessory-category') as HTMLDialogElement | null
        if (dialog) {
            dialog.showModal()
        }
    }
    ...
    return (
        <button className="btn btn-ghost w-fit ml-2 p-1" title="Add New Accessory Category" onClick={openModal}>
            <Plus />
        </button>
    )
}

export const AddAccessoryCategoryModal = () => {
    ...
    return (
        <dialog id="add-new-accessory-category" className="modal">
